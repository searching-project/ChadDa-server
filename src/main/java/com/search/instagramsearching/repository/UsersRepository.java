...
public interface UsersRepository extends JpaRepository<Users,Long> {
    ...
    @Query(value = "SELECT sid, profile_name, business_account_tf, firstname_lastname, profile_id, n_posts, following, followers, description, url FROM users u\n" +
            ...
            nativeQuery = true)
    List<UserSearchResponseDto> ngramNatualSearch(@Param("keyword")String keyword, String original, @PageableDefault Pageable pageable);
    ...
    @Query(value = "SELECT sid, profile_name, business_account_tf, firstname_lastname, profile_id, n_posts, following, followers, description, url FROM users u\n" +
            ...
            nativeQuery = true)
    List<UserSearchResponseDto> ngramBooleanSearch(@Param("keyword")String keyword, String original, @PageableDefault Pageable pageable);
}